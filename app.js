...
function showSpecifications() {
    ...
    specificationsContainer.innerHTML = `
        ...
        <p><strong>Memory (RAM):</strong> ${selectedMobile.memory.ram} GB</p>
        <p><strong>Storage:</strong> ${selectedMobile.memory.storage} GB</p>
        <p><strong>Main Camera:</strong> ${selectedMobile.camera.rear.main}</p>
        <p><strong>Front Camera:</strong> ${selectedMobile.camera.front}</p>
        <p><strong>Battery:</strong> ${selectedMobile.battery} mAh</p>
        <p><strong>Operating System:</strong> ${selectedMobile.operatingSystem}</p>
        <p><strong>Special Features:</strong> ${selectedMobile.specialFeatures.join(", ")}</p>
    `;
}

// Prevent modification of the mobiles object
Object.freeze(mobiles);

let exp = "faraz" || (true + false) + 5 && " " || "true";
console.log(exp); // Output: "faraz"
...
console.log(exp2); // Output: undefined
